package com.rafaelbarros.delivery.client.invoker;
...
import com.rafaelbarros.delivery.client.invoker.auth.Authentication;
import com.rafaelbarros.delivery.client.invoker.auth.HttpBasicAuth;
import com.rafaelbarros.delivery.client.invoker.auth.HttpBearerAuth;
import com.rafaelbarros.delivery.client.invoker.auth.ApiKeyAuth;
import com.rafaelbarros.delivery.client.invoker.auth.OAuth;
...
@Component("com.rafaelbarros.delivery.client.invoker.ApiClient")
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "http://delivery-api.com";
    ...
    protected void init() {
        ...
        authentications.put("delivery_auth", new OAuth());
